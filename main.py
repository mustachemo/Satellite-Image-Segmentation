...
from configs import PREPPED_TEST_IMAGES, PREPPED_TEST_MASKS, UQ_TEST_EXAMPLE_INDEX, DROPOUT_RATE, NUM_SAMPLES_MC_DROPOUT_PREDICTION, X_DIMENSION, Y_DIMENSION
